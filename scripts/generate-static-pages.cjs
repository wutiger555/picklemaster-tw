...
async function generateStaticPages() {
    try {
        ...
        const INDEX_PAGES = [
            ...
            },
            {
                ...
                items: [
                    ...
                    { href: '/play', label: '揪團約打', sub: '只在報名、開團、按「我會去」或評價球場時建立資料：暱稱、頭像樣式、自填程度、報名紀錄與一組隨機代號，存於 Cloudflare 雲端（境外），不蒐集姓名、email 或電話。IP 只以雜湊暫存 2 天用於防濫用。報名明細一年後自動刪除，可隨時在「我的團」頁面自行刪除' },
                    { href: '/privacy-policy', label: '第三方服務', sub: 'Google AdSense 可能使用 Cookies 顯示廣告；地圖圖磚、天氣資料、字型與外部影片由第三方提供，這些服務可能有自己的紀錄行為' },
                    { href: '/privacy-policy', label: '你的權利', sub: '可查詢、更正、要求停止使用或刪除你的資料。揪團資料可在「我的團」頁面直接修改或刪除，其他需求請透過聯絡頁面' },
                ],
      ...
      <main style="max-width:960px;margin:0 auto;padding:24px 16px;font-family:system-ui,-apple-system,'PingFang TC','Microsoft JhengHei',sans-serif;color:#1f2937;line-height:1.7;">
        ...
        // 球場 157 筆本來就有人工查證日（last_updated），文章有 updatedDate，
