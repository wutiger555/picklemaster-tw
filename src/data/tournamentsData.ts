...
export const TOURNAMENTS_2026: Tournament[] = [
  ...
  {
    id: 'tmlp-kaohsiung-2026',
    name: '2026 TMLP 台灣匹克球積分巡迴賽 高雄站',
    nameEn: 'TMLP Taiwan Pickleball Tour - Kaohsiung 2026',
    date: '2026-04-11',
    endDate: '2026-04-12',
    dateLabel: '2026 年 4 月 11 - 12 日',
    venue: '高雄市鼓山高中',
    city: '高雄市',
    region: '南部',
    level: '區域',
    ...
    summary: 'TMLP 積分巡迴賽 2026 賽季首站，4 月 11、12 日於高雄鼓山高中舉行。全站採男雙／女雙／混雙三項，成績計入 TMLP 年度積分。',
    categories: ['男子雙打', '女子雙打', '混合雙打'],
    officialUrl: 'https://www.tmlp.com.tw/events',
  },
  {
    id: 'tmlp-chiayi-2026',
    name: '2026 TMLP 台灣匹克球積分巡迴賽 嘉義站',
    nameEn: 'TMLP Taiwan Pickleball Tour - Chiayi 2026',
    date: '2026-05-30',
    endDate: '2026-05-31',
    dateLabel: '2026 年 5 月 30 - 31 日',
    venue: '嘉義市國民運動中心',
    city: '嘉義市',
    region: '南部',
    level: '區域',
    status: 'completed',
    organizer: 'TMLP 台灣匹克球積分巡迴賽',
    summary: 'TMLP 積分巡迴賽第 2 站，於嘉義市國民運動中心舉行。除積分外另提供紀念品與補給，成績同步計入 DUPR。',
    categories: ['男子雙打', '女子雙打', '混合雙打'],
    officialUrl: 'https://www.tmlp.com.tw/events',
  },
  {
    id: 'tmlp-miaoli-2026',
    name: '2026 TMLP 台灣匹克球積分巡迴賽 苗栗站',
    nameEn: 'TMLP Taiwan Pickleball Tour - Miaoli 2026',
    date: '2026-06-27',
    endDate: '2026-06-28',
    dateLabel: '2026 年 6 月 27 - 28 日',
    venue: '竹南運動公園籃球場（苗栗縣竹南鎮新南里公園路55號）',
    city: '苗栗縣',
    region: '中部',
    level: '區域',
    status: 'completed',
    organizer: 'TMLP 台灣匹克球積分巡迴賽',
    summary: 'TMLP 積分巡迴賽第 3 站，於苗栗竹南運動公園舉行。苗栗縣目前沒有匹克球專用場館，這站是當地少見的全國級賽事。',
    categories: ['男子雙打', '女子雙打', '混合雙打'],
    officialUrl: 'https://www.tmlp.com.tw/events',
  },
  {
    ...
    venue: '王爺壟運動公園（新竹縣湖口鄉信義村中山路一段700號）',
    city: '新竹縣',
    region: '北部',
    level: '區域',
    status: 'completed',
    organizer: 'TMLP 台灣匹克球積分巡迴賽',
    summary: 'TMLP 積分巡迴賽 2026 下半年首站，已於 8 月 15、16 日在湖口王爺壟運動公園完賽。巡迴賽採積分制，10 月新北站續戰、年終於台北舉行積分邀請賽。',
    categories: ['公開組', '積分組'],
  ...
  },
  {
    ...
    venue: '新北市林口高中（新北市林口區東勢里仁愛路二段173號）',
    city: '新北市',
    region: '北部',
    level: '區域',
    status: 'registration',
    organizer: 'TMLP 台灣匹克球積分巡迴賽',
    summary: 'TMLP 積分巡迴賽 2026 賽季第 5 站，10 月 17、18 日於新北市林口高中舉行，官網顯示報名中。採男雙／女雙／混雙三項，成績計入 TMLP 年度積分，年終台北站為積分邀請制。',
    categories: ['公開組', '積分組'],
    registrationUrl: 'https://www.tmlp.com.tw/events',
    officialUrl: 'https://www.tmlp.com.tw/',
  },
