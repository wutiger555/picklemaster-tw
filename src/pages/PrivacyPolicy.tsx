      ...
      <main className="container mx-auto px-4 py-12">
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-lg">
          ...
          <div className="prose prose-lg max-w-none text-neutral-700">
            ...
            <ul>
              <li><strong>蒐集的資料</strong>：你自己取的暱稱、球拍頭像的樣式、自填的程度與 DUPR（選填）、報名與開團紀錄，以及你在固定球敘按下的「我會去」（只顯示人數，不顯示是誰；球敘過後兩天自動刪除）。系統會替這支手機產生一組隨機代號，用來辨識是同一位球友。我們<strong>不蒐集</strong>真實姓名、email、電話或生日。</li>
            ...
            <h2>4. 你的權利</h2>
            <p>
              依個人資料保護法第 3 條，你可以查詢、閱覽、補充、更正你的資料，也可以要求停止使用或刪除。揪團約打的資料可以直接在「我的球拍」頁面修改暱稱與程度，或按「刪除我的資料」一次清除。刪除後，暱稱會被移除，你之後的報名會取消，候補的球友會自動遞補。其他需求請透過聯絡頁面與我們聯繫。
            </p>
