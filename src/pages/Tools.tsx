...
const TOOLS = [
  {
    ...
    icon: '📊',
    title: 'DUPR 評分模擬器',
    desc: '輸入你與對手 DUPR、比賽結果，預估下一場評分變動',
    tag: '評級',
  },
  {
    to: ROUTES.TOOL_ROTATION,
    icon: '🔁',
    title: '雙打輪轉排程器',
    desc: '5-16 人約球自動排輪次，避免重複配對',
    tag: '約球',
  },
  {
    to: ROUTES.TOOL_BRACKET,
    icon: '🏆',
    title: '比賽籤表產生器',
    desc: '單淘汰、循環賽籤表一鍵生成，支援列印',
    tag: '賽事',
  },
  {
    to: ROUTES.TOOL_COURT_LINES,
    icon: '📐',
    title: '場地劃線指南',
    desc: '完整尺寸、羽球場改匹克球場教學',
    tag: '場地',
  },
  {
    to: ROUTES.SCORER,
      ...
      <div className="min-h-screen bg-gradient-to-b from-white via-neutral-50/30 to-white">
        <section className="pt-20 pb-12 md:pt-28 md:pb-16">
          <div className="container mx-auto px-4 max-w-5xl text-center">
            ...
            >
              匹克球<span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-blue-500">工具箱</span>
            </m.h1>
            <p className="text-base md:text-lg text-neutral-600 max-w-2xl mx-auto leading-relaxed">
              免下載、免註冊、純前端運作。球友、教練、賽事籌辦者需要的所有小工具。
            </p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {TOOLS.map((t, i) => (
              ...
              >
                <Link
                  to={t.to}
                  className="group block bg-white rounded-2xl border border-neutral-100 p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full"
                >
                  ...
                  <h2 className="text-lg font-bold text-neutral-900 mb-2 group-hover:text-emerald-600 transition-colors">
                    {t.title}
                  </h2>
