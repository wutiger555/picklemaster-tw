...
export const pageSEO: Record<string, SEOConfig> = {
  ...
  learning: {
    title: '匹克球技巧教學 | 發球・接發球・正反手・截擊・Dink 全攻略',
    description: '專業匹克球技巧教學！3D互動學習發球技巧、接發球要領、正反手擊球、網前截擊、Dink軟球技術。包含站位指導和球路分析，讓你的匹克球技術快速進步！',
    keywords: '匹克球技巧,匹克球發球,匹克球接發球,匹克球正手,匹克球反手,匹克球截擊,匹克球dink,匹克球戰術,匹克球站位,匹克球擊球'
  },
  faq: {
