...
export const pageSEO: Record<string, SEOConfig> = {
  home: {
    title: '匹克球台灣 Picklemaster | 全台首選教學平台 & 150+ 球場地圖導航',
  ...
  tournaments: {
    ...
    description: '完整掌握 2026 台灣匹克球 26 場賽事：AEPL 職業聯賽、TMLP 積分巡迴賽全 6 站、TCI APP ASIA TOUR 台北站、金碧盃、新竹縣長盃、南華盃、女子公開賽、臺北公開賽、星動盃、共融盃。報名時間、場地、組別一次看。',
...
export const faqStructuredData = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "根據中華民國匹克球協會 (CTPF) 統計，台灣匹克球人口從 2024 年的 14 萬、2025 年的 50 萬，2026 年預估突破 120 萬人。全台已認證教練超過 1,400 人，球場數量已達 150+ 處。匹克球是目前台灣成長最快的新興運動。"
      }
    }
  ]
};
...
export const courtsLocationData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "name": "台灣匹克球場完整列表",
      "description": "收錄台北、新北、基隆、桃園、新竹、台中、彰化、南投、雲林、嘉義、台南、高雄、屏東、宜蘭、花蓮等 17 縣市全台 150+ 個匹克球場的完整資訊",
      "numberOfItems": 156,
      "itemListElement": [
        {
